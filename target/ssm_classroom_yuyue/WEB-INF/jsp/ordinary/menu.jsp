...
<div class="col-md-2">
    <ul class="nav nav-pills nav-stacked" id="nav">
        ...
        <li><a href="${pageContext.request.contextPath}/ordinary/showRecord">Reservation record history<span class="glyphicon glyphicon-pencil pull-right" /></a></li>
        ...
        <li><a href="${pageContext.request.contextPath}/ordinary/cancelApplication?user=<shiro:principal/>">requests in waitlist<sapn class="glyphicon glyphicon-pencil pull-right" /></a></li>
