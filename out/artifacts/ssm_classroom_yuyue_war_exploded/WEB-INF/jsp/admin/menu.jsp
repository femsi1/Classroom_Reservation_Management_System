...
<div class="col-md-2">
    <ul class="nav nav-pills nav-stacked" id="nav">
        <li><a href="${pageContext.request.contextPath}/admin/showRoom">教室信息管理<span class="glyphicon glyphicon-pencil pull-right"/></a></li>
        ...
        <li><a href="${pageContext.request.contextPath}/admin/showRecordReject">拒绝预约记录查询<span class="glyphicon glyphicon-pencil pull-right" /></a></li>
       ...
       <li><a href="${pageContext.request.contextPath}/admin/showUser">修改个人信息<sapn class="glyphicon glyphicon-pencil pull-right" /></a></li>
