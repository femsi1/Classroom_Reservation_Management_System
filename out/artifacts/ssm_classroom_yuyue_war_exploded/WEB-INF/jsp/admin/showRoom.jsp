								...
								<tr>
									...
									<td>
										...
										<button class="btn btn-default btn-xs btn-danger btn-primary"
											onclick="removeRoom(${item.id})">删除</button> <%--<button class="btn btn-default btn-xs btn-danger btn-primary" onClick="location.href='${pageContext.request.contextPath}/admin/removeRoom?id=${item.id}'">删除</button>--%>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
