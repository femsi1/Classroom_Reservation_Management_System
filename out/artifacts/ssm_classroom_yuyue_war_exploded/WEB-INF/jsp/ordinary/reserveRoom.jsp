        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <h1 style="text-align: center;">添加教室预约</h1>
                    </div>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form"
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">借用人姓名</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">借用原因</label>
                            <div class="col-sm-10">
