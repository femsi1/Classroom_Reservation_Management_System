...
<div class="col-md-2">
    <ul class="nav nav-pills nav-stacked" id="nav">
        <li><a href="${pageContext.request.contextPath}/ordinary/showRoom">教室信息<sapn class="glyphicon glyphicon-pencil pull-right" /></a></li>
        ...
        <li><a href="${pageContext.request.contextPath}/ordinary/reserveRoom">预约教室<sapn class="glyphicon glyphicon-pencil pull-right" /></a></li>
        ...
        <li><a href="${pageContext.request.contextPath}/ordinary/showUser">个人信息修改<sapn class="glyphicon glyphicon-pencil pull-right" /></a></li>
