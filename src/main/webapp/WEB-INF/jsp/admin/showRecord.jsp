			...
			<div class="col-md-10">
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="row">
							<h1 class="col-md-5">Appointment record inquiry</h1>
							...
							<nav style="text-align: center">
								<ul class="pagination">
									...
									<c:if test="${pagingVo.curentPageNo+1 <= pagingVo.totalCount}">
										<li><a
											href="${pageContext.request.contextPath}/admin/showRecord?page=${pagingVo.curentPageNo+1}">${pagingVo.curentPageNo+1}</a></li>
									</c:if>
									<c:if test="${pagingVo.curentPageNo+2 <= pagingVo.totalCount}">
										<li><a
											href="${pageContext.request.contextPath}/admin/showRecord?page=${pagingVo.curentPageNo+2}">${pagingVo.curentPageNo+2}</a></li>
									</c:if>
									<c:if test="${pagingVo.curentPageNo+3 <= pagingVo.totalCount}">
										<li><a
											href="${pageContext.request.contextPath}/admin/showRecord?page=${pagingVo.curentPageNo+3}">${pagingVo.curentPageNo+3}</a></li>
									</c:if>
